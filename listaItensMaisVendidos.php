...
<head>
  ...
  <title><?php echo "ITENS MAIS VENDIDOS"; ?> - MmVeículos</title>
...
<div class="jumbotron">
    <div class="container">
        <h1><?php echo "ITENS MAIS VENDIDOS"; ?> </h1>
                                                ...
                                                <div class="product-wrap">
                                                    <div class="product-images">
                                                        <div class="shop-loop-thumbnail shop-loop-front-thumbnail">
                                                            <a href="veiculoDetalhado.php?id=<?php echo $prod[$i]['tipoVeiculo'] ?>&codigo=<?php echo $prod[$i]['codigoVeiculo'] ?>"><img width="450" height="450" src=<?php echo $prod[$i]['imagem1']; ?> alt=""/></a>
                                                        </div>
                                                        <div class="shop-loop-thumbnail shop-loop-back-thumbnail">
                                                            <a href="veiculoDetalhado.php?id=<?php echo $prod[$i]['tipoVeiculo'] ?>&codigo=<?php echo $prod[$i]['codigoVeiculo'] ?>"><img width="450" height="450" src=<?php echo $prod[$i]['imagem2']; ?> alt=""/></a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <figcaption>
                                                    <div class="shop-loop-product-info">
                                                      <h3 class="product_title">
                                                          <a href="veiculoDetalhado.php?id=<?php echo $prod[$i]['tipoVeiculo'] ?>&codigo=<?php echo $prod[$i]['codigoVeiculo'] ?>"><?php echo "TOP ".($i+1); echo "<br />";  echo $prod[$i]['nome']; ?></a>
                                                      </h3>
                                                      <div class="info-price">
                                                      <span class="price">
                                                      <span class="amount"><?php if($prod[$i]['COUNT(*)'] > 1){echo $prod[$i]['COUNT(*)']; echo " UNIDADES";} else{echo $prod[$i]['COUNT(*)']; echo " UNIDADE";} ?></span>
                                                      </span>
                                                        </div>
                                                    </div>
                                                </figcaption>
