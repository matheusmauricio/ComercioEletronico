				...
				<div class="container-full">
					<div class="row">
						<div class="col-md-12">
                            ...
                            <form class="cart" name="form1" method="post" action="comprarVeiculoProc.php?id=<?php echo $id; ?>&codigo=<?php echo $prod[$x-1]['codigo']; ?>">
                              <div class="add-to-cart-table">
                                <input type="text" name="codigoUsuario" value="<?php echo $usuario[0]['codigo']; ?>" hidden>
                                <input type="text" name="codigoVeiculo" value="<?php echo $prod[$x-1]['codigo']; ?>" hidden>
                                <input type="text" name="tipoVeiculo" value="<?php echo $id; ?>" hidden>
                                <input type="text" name="valorVenda" value="<?php echo $prod[$x-1]['preco']; ?>" hidden>
