...
<?php
  ...
  include_once("dadosComprasProc.php");
  ?>
...
<head>
  ...
  <title><?php echo "Minhas Compras"; ?> - MmVeículos</title>
                                                ...
                                                <figcaption>
                                                    <div class="shop-loop-product-info">
                                                      <h3 class="product_title">
                                                          <a href="veiculoDetalhado.php?id=<?php echo $prod[$i]['tipoVeiculo'] ?>&codigo=<?php echo $prod[$i]['codigoVeiculo'] ?>"><?php echo $prod[$i]['nome']; ?></a>
                                                      </h3>
                                                      <div class="info-price">
                                                      <span class="price">
                                                      <span class="amount">R$ <?php echo $prod[$i]['valorVenda']; ?></span>
                                                      </span>
